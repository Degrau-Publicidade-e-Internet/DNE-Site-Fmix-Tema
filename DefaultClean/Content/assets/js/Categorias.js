...
$(document).ready(function () {
    ...
    $('body').on('click', '.dg-categoria-sidebar .dg-header-minhaconta-modal-cadastro .dg-header-minhaconta-modal-footer-voltar-btn', function() {
        menuLoginMobileWrapper.find('.dg-ativo').removeClass('dg-ativo');
    });
    
    $('body').on('click', '.dg-categoria-sidebar .dg-header-minhaconta-modal-esquecisenha .dg-header-minhaconta-modal-footer-voltar-btn', function () {
        menuLoginMobileWrapper.find('.dg-header-minhaconta-modal-esquecisenha.dg-ativo').removeClass('dg-ativo');
        menuLoginMobileWrapper.find('.dg-header-minhaconta-modal-login').addClass('dg-ativo');
    });

    $('body').on('click', '.dg-categoria-sidebar .dg-header-minhaconta-modal-esqueci-url > a', function () {
        startMenuLoginMobile();
        menuLoginMobileWrapper.find('.dg-header-minhaconta-modal-esquecisenha').addClass('dg-ativo');
    });

    $('body').on('click', ".dg-categoria-sidebar .dg-header-busca-auto-lista-vertodos", function(){
