        ...
        $.ajax({
            ...
            success: function (response) {
                if (response.StatusCode > 0) {
                    ...
                    $.alertpadrao({ type: 'html', text: "E-mail de redefinição de senha enviado com sucesso.", addClass: "dg-positivo" });
                }
